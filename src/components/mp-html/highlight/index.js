...
e.prototype.onParse = function (e, a) {
  if ('pre' === e.name) {
    ...
    ;(n = i.indexOf('language-')), -1 === n ? ((n = i.indexOf('lang-')), -1 === n ? ((i = 'language-text'), (n = 9)) : (n += 5)) : (n += 9)
    var c
    ...
    if (l.children.length) {
      ...
      if (
        (e.c && (e.c = void 0),
        r.languages[h] && (l.children = new t(this.vm).parse('<pre>' + r.highlight(o, r.languages[h], h).replace(/token /g, 'hl-') + '</pre>')[0].children),
        ...
        s.copyByLongPress && ((e.attrs.style += (e.attrs.style || '') + ';user-select:none'), (e.attrs['data-content'] = o), a.expose()),
        s.showLineNumber)
      ) {
