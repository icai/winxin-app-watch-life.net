          ...
          if (e) {
            for (
              ...
              if (((l = t = u[f]), f !== h - 1)) {
                ...
                ;(!this.options.pedantic || this.options.smartLists ? r[2][r[2].length - 1] !== a[a.length - 1] : o == (1 === r[2].length)) &&
              ...
              ;(r = t.length),
                ...
                r && (c.loose = !0),
                this.options.gfm && ((s = void 0), (i = /^\[[ xX]\] /.test(t)) && ((s = ' ' !== t[1]), (t = t.replace(/^\[[ xX]\] +/, '')))),
                c.items.push({
                  type: 'list_item',
                  raw: l,
                  task: i,
        ...
        (r.inlineTokens = function (e, t, n, r) {
            ...
            if (0 < c.length)
              for (; null != (s = this.tokenizer.rules.inline.reflinkSearch.exec(o)); )
                c.includes(s[0].slice(s[0].lastIndexOf('[') + 1, -1)) &&
                  (o = o.slice(0, s.index) + '[' + B('a', s[0].length - 2) + ']' + o.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
          }
          ...
          for (; e; )
            if ((l || (a = ''), (l = !1), (i = this.tokenizer.escape(e)))) (e = e.substring(i.raw.length)), t.push(i)
              ...
              (e = e.substring(i.raw.length)), 'link' === i.type && (i.tokens = this.inlineTokens(i.text, [], !0, r)), t.push(i)
