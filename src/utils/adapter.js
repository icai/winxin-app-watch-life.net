    ...
    success(res) {
      ...
      if (!inFinChat) {
        ...
        getOptionsRequest.then((res) => {
          ...
          var enable_index_interstitial_ad =
            res.data.enable_index_interstitial_ad;
          var enable_detail_interstitial_ad =
            res.data.enable_detail_interstitial_ad;
          var enable_topic_interstitial_ad =
            res.data.enable_topic_interstitial_ad;
          var enable_list_interstitial_ad =
            res.data.enable_list_interstitial_ad;
          var enable_hot_interstitial_ad = res.data.enable_hot_interstitial_ad;
          var enable_comments_interstitial_ad =
            res.data.enable_comments_interstitial_ad;
          var enable_live_interstitial_ad =
